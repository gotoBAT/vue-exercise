<template>
  <div>
    <h1>Person组件里共有:{{persons.length}}人</h1>
    <h1>总和:{{ he }}</h1>
    ...
    <button @click="incrementEven(n)">若为偶数则加</button>
...
export default {
  ...
  computed: {
    ...mapState({he:'sum',mingzi:'name',nianling:'age',persons:'personList'}),
  ...
  methods: {
    ...
    ...mapActions({incrementEven:'addEven',incrementWait:'addWait'})
  },
};
</script>
